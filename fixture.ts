...
async function run() {
  ...
  const [John, Jane] = await artistController.createMultiple([
    { name: 'John', information: 'hello', image: 'images/artists/artist_1.jpg' },
    { name: 'Jane', information: 'hello Jane', image: 'images/artists/artist_2.jpg' }
  ]);


  const [albumJohn1, albumJohn2, albumJane1,  albumJane2] = await albumController.createMultiple( [
    { title: 'albumJohn1', artist: John._id, date: 2023, image: 'images/albums/album_1_artist_1.jpg' },
    { title: 'albumJohn2', artist: John._id, date: 2019, image: 'images/albums/album_1_artist_2.jpg' },
    { title: 'albumJane1', artist: Jane._id, date: 2005, image: 'images/albums/album_2_artist_1.jpg' },
    { title: 'albumJane2', artist: Jane._id, date: 2009, image: 'images/albums/album_2_artist_2.jpg' }
  ]);
